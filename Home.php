...
<link rel="stylesheet" href="Home.css" media="screen">
  ...
  <body class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-header u-header" id="sec-7bb5"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-8655">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <div class="u-expanded-width u-table u-table-responsive u-table-1">
          <table class="u-table-entity u-table-entity-1">
            ...
            <tbody class="u-table-alt-palette-1-light-3 u-table-body" style="text-align: center;">
                <?php while($row = mysqli_fetch_array($result)) { ?>
              <tr style="height: 65px;">
                <td class="u-table-cell" style="text-align: center;"><img src="<?php echo $row["product_image"]; ?>"; style="width:80px;height:60px"></td>
                <td class="u-table-cell" style="text-align: center;"><?php echo $row["product_name"]; ?></td>
                <td class="u-table-cell" style="text-align: center;">RM <?php echo $row["product_price"]; ?></td>
                <td class="u-table-cell" style="text-align: center;"><?php echo $row["product_condition"]; ?></td>
              </tr>
             <?php } ?>
