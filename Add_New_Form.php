	...
	if ($error === 0) {
		if ($img_size > 500000) {
			...
			if (in_array($img_ex_lc, $allowed_exs)) {
				...
				$sql = "INSERT INTO product (product_name, product_image, product_desc, product_price, product_quantity, product_condition) VALUES ('$product_name',' $sql_name_data','
$product_desc','$product_price','$product_quantity','$product_condition')"; 
