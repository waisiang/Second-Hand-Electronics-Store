...
<link rel="stylesheet" href="Add-New.css" media="screen">
        ...
        <div class="u-form u-form-1">
          <form action="/Add_New_Form.php" method="post" enctype="multipart/form-data" >
            ...
            <div >
              ...
              <input type="file" placeholder="" id="product_image" name="product_image">
            </div>
            <div >
              <label  class="u-label u-label-2">Product Price</label>
              <input type="text" placeholder="" id="product_price" name="product_price">
            </div>
           
            <div>
              <label class="u-label u-label-3">Product Quantity</label>
              <input type="text" placeholder="" id="product_quantity" name="product_quantity" >
            </div>
            <div>
              <label class="u-label u-label-4">Product Condition</label>
              <input type="text" placeholder="" id="product_condition" name="product_condition">
            </div>
            <div >
              <label>Product Description</label>
              <textarea rows="4" cols="50" id="product_desc" name="product_desc" required=""></textarea>
            </div>
